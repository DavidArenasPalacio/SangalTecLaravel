        ...
        <form action="/rol/guardar" method="POST" id="form">
            ...
            <div class="mt-5">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="submit" class="button bg-theme-1 text-white mt-5 tooltip" title="Presione el boton izquierdo del mouse aqui para guardar el registro del rol">Guardar</button>
                </div>
