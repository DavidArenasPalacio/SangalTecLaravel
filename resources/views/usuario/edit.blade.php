...
<div class="box p-5">
    ...
    <form action="/usuario/actualizar" method="POST" id="form" class="mt-5">
        ...
        <div class="flex justify-between">
            <a href="/usuario" class="button  border bg-gray-600 text-white mr-2 mt-5 tooltip"
                title="Presione el boton izquierdo del mouse aqui para volver a la lista de los usuarios">Volver</a>
            <button type="submit" class="button bg-theme-1 text-white mt-5 tooltip"
                title="Presione el boton izquierdo del mouse aqui para guardar los datos editados del usuario">Guardar</button>
        </div>
    </form>
</div>
@endsection
