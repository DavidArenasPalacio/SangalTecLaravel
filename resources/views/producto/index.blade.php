...
<div class="w-full">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="/producto/crear" class="button flex  text-white bg-theme-1 shadow-md mr-2 tooltip" title="Click aqui para ingresar al formulario de registro de producto"><i data-feather="plus" class="mx-auto"></i> Registrar un nuevo producto</a>
        </div>
        @endif
