...
<div class="box p-5">
    ...
    <form action="/producto/guardar" method="POST" class="mb-5 py-5" id="form">
        ...
        <div class="flex justify-between">
            ...
            <button type="submit" class="button bg-theme-1 text-white mt-5 tooltip" title="Presione el boton izquierdo del mouse aqui para guardar el registro del producto">Guardar</button>
        </div>
    </form>
</div>
@endsection
