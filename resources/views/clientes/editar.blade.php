    ...
    <div class="box p-5">
        ...
        <form action="{{ route('clientes.actualizar', $clientes->id) }}" method="POST" id="form">
            ...
            <div class="flex flex-col sm:flex-row items-center">
                ...
                <div class="w-full mr-2">
                    ...
                    <input type="text" name="nombre"
                        ...
                        placeholder="Ingrese el nombre del cliente" maxlength="125"
            ...
            <div class="flex justify-between">
                ...
                title="Presione el boton izquierdo del mouse aqui para guardar los datos editados del cliente">Guardar</button>
            </div>
        </form>
    </div>
@endsection
