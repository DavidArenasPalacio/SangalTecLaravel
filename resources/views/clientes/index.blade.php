    ...
    <div class="m-auto" style="width: 80% !important">
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <a href="/clientes/crear" class="button flex  text-white bg-theme-1 shadow-md mr-2 tooltip"
                    title="Presione el boton izquierdo del mouse aqui para ingresar al formulario de registro de cliente"><i data-feather="plus"
