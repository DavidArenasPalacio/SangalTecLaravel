    ...
    <div class="w-64 m-auto  intro-y box p-5">
        ...
        <form action="/categoria/actualizar" method="POST" id="form" class="mt-5">
            ...
            <div class="flex justify-between">
                ...
                <button type="submit" class="button bg-theme-1 text-white mt-5 tooltip" title="Presione el boton izquierdo del mouse aqui para guardar los datos editados de la categoria">Guardar</button>
            </div>
        </form>
    </div>
</div>
