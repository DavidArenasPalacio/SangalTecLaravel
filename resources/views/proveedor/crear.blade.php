        ...
        <form action="/proveedor/guardar" method="POST" id="form" class="mt-5">
            ...
            <div class="flex flex-col sm:flex-row items-center">
                ...
                <div class="w-full mr-2">
                    ...
                    <input type="text" id="nombre" name="nombre"
                        ...
                        placeholder="Ingrese el nombre del proveedor" maxlength="125" value="{{ old('nombre') }}">
                    @error('nombre')
                ...
                <div class="w-full">
                    ...
                    <input type="email" id="correo" name="correo"
                        ...
                        placeholder="Ingrese el correo del proveedor" maxlength="225" value="{{ old('correo') }}">
                    @error('correo')
                        <div class="text-theme-6 mt-2"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
            ...
            <div class="flex flex-col sm:flex-row items-center sm:mt-2">
                <div class="w-full mr-2">
                    ...
                    <input type="text" id="telefono" name="telefono"
                        ...
                        placeholder="Ingrese el teléfono del proveedor" value="{{ old('telefono') }}">
                    @error('telefono')
                        <div class="text-theme-6 mt-2"><strong>{{ $message }}</strong></div>
                    @enderror
                </div>
            ...
            <div class="flex justify-between">
                ...
                <button type="submit" class="button bg-theme-1 text-white mt-5 tooltip"
                    title="Presione el boton izquierdo del mouse aqui para guardar el registro del proveedor">Guardar</button>
            </div>
        </form>
    </div>
@endsection
